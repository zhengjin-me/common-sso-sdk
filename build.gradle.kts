...
val commonDictVersion: String by project
...
dependencies {
    ...
    api("me.zhengjin:common-dict:$commonDictVersion")
    api("org.springframework.boot:spring-boot-starter-data-redis")
    api("cn.dev33:sa-token-spring-boot-starter:$saTokenVersion")
    api("cn.dev33:sa-token-sso:$saTokenVersion")
